...
export function MerchantReportForm() {
    ...
    const renderInventoryRows = (section: 'salesfloor' | 'stockroom') => (
        <div class="inventory-table" role="table" aria-label={section === 'salesfloor' ? 'Piso de Venta' : 'Almacén'}>
        ...
        <form>
            ...
            <fieldset>
                ...
                {products.length > 0 ? (
                    <>
                        <h3>Piso de Venta</h3>
                        {renderInventoryRows('salesfloor')}
                        <h3>Almacén</h3>
                        {renderInventoryRows('stockroom')}
                    </>
                ) : (
